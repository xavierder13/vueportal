        ...
        <!-- <div class="d-flex justify-content-end mb-3">
          <div>
            <v-btn
              ...
              small
              @click="exportData()"
              v-if="userPermissions.employee_attlog_export && userPermissions.employee_attlog_list_all"
            >
        ...
        <v-card>
          ...
          >
            ...
            >
              ...
              <td> 
                <v-btn x-small color="primary" @click="importExcel(items)" v-if="userPermissions.employee_attlog_import"> 
  ...
  computed: {
    filteredBranches() {
      ...
      this.branches.forEach((value) => {
        if (this.userPermissions.employee_attlog_list_all) {
          branches.push(value);
        } else {
